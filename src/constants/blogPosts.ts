...
export const blogPosts: BlogPost[] = [
  {
    ...
    author: "Lindsay Owens, LMFT",
    publishedDate: "2026-01-18T00:00:00.000Z",
    tags: ["guidance", "widow", "widower", "essentials", "social security"],
    content: `By: Lindsay Owens, LMFT
January 18, 2026
...
Understanding these rules ahead of time can help you make informed decisions without unintended financial consequences.
...
This is exactly where LifeBridge Guidance steps in.
...
You focus on healing and family. We handle the roadmap.
...
Reach out when you're ready. We'll take the next step together.`,
  },
  {
    ...
    description:
      "Practical steps for handling Fidelity accounts after the loss of a spouse",
    author: "LifeBridge Guidance",
    publishedDate: "2026-01-20T00:00:00.000Z",
    tags: ["fidelity", "accounts", "financial", "spouse"],
    content: `**By: LifeBridge Guidance**  
...
**Fidelity Estate / Transition Services Phone Number:** 📞 **800-544-0003**
...
You'll need multiple certified copies — usually 10–15 — for financial institutions, insurance companies, and legal matters.

Most funeral homes help order these for you.
...
Nothing needs to be perfect right now. The goal is safety, clarity, and time — not speed.
